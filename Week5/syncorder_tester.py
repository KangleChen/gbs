...
# [GCC 6.3.0 20170516]
# Embedded file name: ./syncorder_tester.py
...
if __name__ == '__main__':
    try:
        syncorder = open('%s.c' % PROG_NAME, 'r').read()
    except:
        pass

    if 'pthread_cond' not in syncorder:
        print 'Missing command: pthread_cond(...)'
        sys.exit(1)
    points_received = 0.0
    points_received += check_stdout(NUM_THREADS, 'o')
